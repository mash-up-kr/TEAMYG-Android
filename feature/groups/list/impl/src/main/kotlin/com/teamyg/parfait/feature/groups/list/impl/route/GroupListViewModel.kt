...
data class MockToppingGroup(
    ...
    val colorChipType: YGColorChipType = YGColorChipType.NametagChip1
}

data class GroupListUiState(
    // Todo : 임시로 MockToppingGroup 으로 설정하였습니다
    val groupList: List<MockToppingGroup> = listOf(
        MockToppingGroup("매시업1", "https://pds.joongang.co.kr/news/component/htmlphoto_mmdata/201611/16/htm_2016111623638229254.png", "3분전"),
        MockToppingGroup("매시업매시업매시업", "https://i.pinimg.com/236x/d8/a6/cb/d8a6cbb02bc2c5c27ae238db2e89425d.jpg", "10분전"),
        MockToppingGroup("매시업3", "https://i.namu.wiki/i/izVXkClWRy9-s5DAkC_lGo3za4Zy9seGH1V6AM0qZJzsckE9eWe6-Hp-1OvJm_DkVv7BL7U0Ar7QB89ApaklkQ.webp", "1시간전"),
        MockToppingGroup("매시업4", "https://https://i.namu.wiki/i/h01cpKjF51MCkPZBi9-x7RMltpQbztoVgRB_0fnqrGA6S0M_9mcxpptqAmhr1YxCo0fWeErT3DGg55Nb8O2WeA.webp", "1시간전"),
    ),
