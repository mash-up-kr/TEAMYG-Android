...
sources: [src-G-001-무한파르페-정책설계, src-G-001-무한파르페-간격-정책-v0.2, src-G-001-무한파르페-간격-정책-v0.1, src-G-001-토핑-정책-v0.1, src-S-101-프로필-닉네임-컬러-규칙-v0.3, src-A-005-그룹명-정책-v0.1, src-기능정의서-v5]
updated: 2026-09-17
---
...
- 그 **Timestamp 텍스트 컬러**는 `v0.2`까지 올린 사람의 `Nametag-Chip` 타입을
  따랐으나, [[src-S-101-프로필-닉네임-컬러-규칙-v0.3]](07-17)이 `Grouptag-Chip`을
  **별도 문서로 이관하며 "별개 매핑"이라고 못박았다.** 이관처 문서가 위키에 없어
  **지금은 무엇을 따르는지 알 수 없다.**
...
- `Grouptag-Chip` Timestamp 컬러가 무엇을 따르는지 알 수 없다. `v0.3`이
  별개 매핑으로 이관했고 이관처 문서가 없다.
- 크림 가로 길이 1안 대 2안.
- 체리의 기능(`TBD`).
- 토핑 이미지 뷰어 정책.
- 화면 재진입 시 자동 재조회 여부.
