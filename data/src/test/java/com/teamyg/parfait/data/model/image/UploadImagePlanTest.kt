...
class UploadImagePlanTest {
    ...
    fun of_nukkiPngUnderLimit_passesThrough() {
        ...
        // When 계획을 세운다
        val plan = UploadImagePlan.of(sourceSize, ImageType.NUKKI, UploadImageFormat.PNG)
    ...
    fun of_limitDiffersByImageType() {
        ...
        val nukkiPlan = UploadImagePlan.of(sourceSize, ImageType.NUKKI, UploadImageFormat.JPEG)
        val backgroundPlan = UploadImagePlan.of(sourceSize, ImageType.BACKGROUND, UploadImageFormat.JPEG)
    ...
    fun of_backgroundPngUnderLimit_reencodesToJpeg() {
        ...
        // When 계획을 세운다
        val plan = UploadImagePlan.of(sourceSize, ImageType.BACKGROUND, UploadImageFormat.PNG)
    ...
    fun of_backgroundJpegAtExactLimit_passesThrough() {
        ...
        // When 계획을 세운다
        val plan = UploadImagePlan.of(sourceSize, ImageType.BACKGROUND, UploadImageFormat.JPEG)
