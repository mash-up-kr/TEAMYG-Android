...
class UserConfigRepositoryImpl @Inject constructor(
     ...
     */
    override suspend fun updateIsShowCanvasTutorial(isShowCanvasTutorial: Boolean) {
        val current = userConfig.first() ?: UserConfigVO()
        localDataSource.save(current.copy(isShowCanvasTutorial = isShowCanvasTutorial))
    }
