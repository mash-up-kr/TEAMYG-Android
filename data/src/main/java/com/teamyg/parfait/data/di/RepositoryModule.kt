...
import com.teamyg.parfait.data.repository.debug.DebugModeRepositoryImpl
...
interface RepositoryModule {
    ...
    @Binds
    @Singleton
    fun bindImageFileRepository(imageFileRepositoryImpl: ImageFileRepositoryImpl): ImageFileRepository
